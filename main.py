...
# Definir variáveis de ambiente diretamente no script
os.environ['EMAIL_USER'] = 'Seu_Email'
os.environ['EMAIL_PASS'] = 'Sua_Senha'

# Obter as variáveis de ambiente
username = os.getenv("EMAIL_USER")
password = os.getenv("EMAIL_PASS")

print(f"EMAIL_USER: {username}")  # Mensagem de depuração
print(f"EMAIL_PASS: {password}")  # Mensagem de depuração
...
def start_unseen_email_processing():
    email_handler.process_unseen_emails(keywords_listbox.get(0, tk.END))
...
def start_all_email_processing():
    email_handler.process_all_emails(keywords_listbox.get(0, tk.END))
    root.after(0, update_resumes_listbox, all_resumes_listbox)
    root.after(0, update_resumes_listbox, filtered_resumes_listbox, True)
